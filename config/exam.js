...
exams[271] = {
  ...
  author: "来源:caitong",
  origin: "2027届年级部",
  rollSlogan: ["高二第二学期期末考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-06-30", "07:55", "10:25");
    $("物理", "2026-06-30", "10:45", "12:00");
    $("化学", "2026-06-30", "14:30", "15:45");
    $("生物", "2026-06-30", "15:50", "17:05");
    $("数学", "2026-07-01", "07:40", "09:40");
    $("英语", "2026-07-01", "10:00", "12:00");
  }
};
...
exams[274] = {
  ...
  schedule() {
    $("语文", "2026-06-30", "07:55", "10:25");
    $("历史", "2026-06-30", "10:45", "12:00");
    $("政治", "2026-06-30", "14:30", "15:45");
    $("地理", "2026-06-30", "15:50", "17:05");
    $("数学", "2026-07-01", "07:40", "09:40");
    $("英语", "2026-07-01", "10:00", "12:00");
  }
...
exams[281] = {
  type: "高一物化生",
  author: "来源:高一30班 Lucas Alexander Danniel",
  origin: "2028届年级部",
  rollSlogan: ["高一第二学期期末考试：请以实际铃声为准。"],
  schedule() {
    $("英语", "2026-06-30", "14:20", "16:20");
    $("物理", "2026-06-30", "16:50", "18:20");
    $("语文", "2026-07-01", "07:40", "10:10");
    $("化学", "2026-07-01", "10:40", "12:10");
    $("数学", "2026-07-01", "14:20", "16:20");
    $("生物", "2026-07-01", "16:50", "18:20");
  }
};
